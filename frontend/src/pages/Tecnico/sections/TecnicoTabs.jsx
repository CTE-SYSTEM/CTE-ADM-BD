...
export const TecnicoTabs = ({
  ...
  <div className="mb-8">
    <nav className="flex flex-wrap gap-3">
      <TecnicoTabButton active={activeTab === 'diagnosticos'} onClick={() => onChange('diagnosticos')} icon={<ClipboardList size={16} />} label={`En Revision (${diagnosticosEnRevision.length})`} />
